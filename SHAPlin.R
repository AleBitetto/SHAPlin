...
evaluate_SHAP = function(dataSample, sample_size = 100, trained_model_prediction_function = NULL, obs_index_to_evaluate = NULL,
  ...
  # trained_model_prediction_function: named list of function(predictors) -> prediction (vector/matrix of values for regression/probabilities,
  #                                   vector of strings (classes) for classification).
